                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-7 text-end">
                                ...
                                <?php } ?>
                                <?php if($role == 'admin'){ ?>
                                    &nbsp;<a href="javascript:void(0)" id="btnDeleteOvertime" class="btn btn-outline-danger"><i class="fa fa-trash"></i> Hapus</a>
                                <?php } ?>
                            </div>
                        </div>
...
<?php if($role == 'admin'){ ?>
    $(document).on('click', '#btnDeleteOvertime', function(){
        ...
        $.ajax({
            ...
            beforeSend  : function(){
                btn.html('<i class="fa fa-spinner fa-spin"></i> Menghapus...').addClass('disabled')
            },
            success : function(res){
                if(res.status){
                    window.location.href = "<?= site_url('hr/overtime/acc') ?>";
                }else{
                    alert(res.message || 'Gagal menghapus.');
                    btn.html('<i class="fa fa-trash"></i> Hapus').removeClass('disabled');
                }
            },
            error : function(){
