...
<input type="hidden" name="branch_id" value="<?= $branch_id ?>">
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name() ?>" value="<?php echo $this->security->get_csrf_hash() ?>">
<input type="hidden" name="id_deduction" id="e_id">
...
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name() ?>" value="<?php echo $this->security->get_csrf_hash() ?>">
<input type="hidden" name="id_deduction" id="delete-id">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.toggle-deduction-status', function(){
        var btn = $(this);

        $.ajax({
            url         : "<?= site_url('change_status_deduction') ?>",
            dataType    : "json",
            method      : "POST",
            data : {
                myToken : "<?php echo $this->security->get_csrf_hash() ?>",
