 ...
 * Hermes_wa Library
 *
 * Integrasi WhatsApp gateway Hermes.
 * Endpoint: POST https://wa-api.4dm1n.my.id/send
 * Auth: header X-API-Key
 * Body: { chatId, message } — chatId = nomor 628xxx + '@c.us'
 */
class Hermes_wa {
    ...
    private $api_key;
    private $timeout = 30;
    private $endpoint = 'https://wa-api.4dm1n.my.id/send';
    ...
    public function send($phone, $message) {
        if (empty($this->api_key)) {
            return [
                'success'   => false,
                'http_code' => 0,
                'response'  => 'API key Hermes belum dikonfigurasi.'
            ];
        }
