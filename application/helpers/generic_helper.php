<?php
	/* Fungsi lock penggajian (payroll_locked_* dkk) PINDAH ke
	   application/helpers/payroll_lock_helper.php — jangan tambahkan
	   logika payroll di file helper umum ini. */
